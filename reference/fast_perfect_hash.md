...
---
```
struct checked_fast_perfect_hash;
```

`fast_perfect_hash` is an implementation of [`type_hash`](/reference/type_hash.md). It uses a very fast
hash function:
...
The size of the zero-based interval containing all the possible output values of
`hash_type_id`.
