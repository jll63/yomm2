...
Like [define_method](/reference/define_method.md), but the definition has the `inline` storage class, and
...
See the documentation of [method_container](/reference/method_container.md) for more information on method
containers.
