// Copyright (c) 2018-2022 Jean-Louis Leroy
    ...
    #define yOMM2_ALIST(N, I, A)                                               \
        BOOST_PP_COMMA_IF(I)                                                   \
        std::forward<::yorel::yomm2::detail::remove_virtual<                   \
    ...
    #define YOMM2_STATIC_DECLARE_3(R, ID, ARGS)                                \
        yOMM2_DECLARE(                                                         \
            R, ID, ARGS, yOMM2_WHEN_STATIC, ::yorel::yomm2::default_policy)
    ...
    #define yOMM2_DECLARE(R, ID, ARGS, IF_STATIC, POLICY)                      \
        ...
        inline R ID(                                                           \
            BOOST_PP_REPEAT(BOOST_PP_TUPLE_SIZE(ARGS), yOMM2_PLIST, ARGS)) {   \
            return yOMM2_method(R, ID, ARGS, POLICY)::fn(BOOST_PP_REPEAT(      \
    ...
    #define yOMM2_DEFINE(NS, RETURN_T, ID, ARGS)                               \
        ...
        _yOMM2_method::add_function<_yOMM2_spec::yOMM2_body> YOMM2_GENSYM(     \
            &next, yOMM2_NAME(typeid(_yOMM2_spec).name(), #ARGS));             \
        }                                                                      \
        }                                                                      \
        ...
        #define YOMM2_DECLARE_METHOD_CONTAINER(...)                            \
            BOOST_PP_CAT(                                                      \
                BOOST_PP_OVERLOAD(                                             \
                    YOMM2_DECLARE_METHOD_CONTAINER_,                           \
